                ...
                <div class="card-body px-0 pt-0 pb-2">
                    ...
                    <form action="{{ route('location-transport.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('id_transport') is-invalid @enderror" id="id_transport" name="id_transport">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('prix_total') is-invalid @enderror" id="prix_total" name="prix_total" step="0.01" min="0" value="{{ old('prix_total') }}">
                            @error('prix_total')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
